...
public class LocalDataManager {
    ...
    public Integer getValues(Context context, String key){

        return !getSharedPreference(context, key, "").equalsIgnoreCase("") ?
                Integer.valueOf(getSharedPreference(context, key, "")) : 0;
    }
