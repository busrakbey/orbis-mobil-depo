...
public class PersonelSorguActivity extends AppCompatActivity implements ExpandableLayout.OnExpansionUpdateListener {
    ...
    List<PersonelSayi> gelenPersonelList;
    ListView listview;
    String gelenSayfaId;
    ...
    private void initToolBar() {
        try {
            ...
            getSupportActionBar().setTitle("Personel Listesi");
    ...
    void getBalOrmaniServis() {
        ...
        call.enqueue(new Callback<List<PersonelSayi>>() {
            ...
            public void onResponse(Call<List<PersonelSayi>> call, Response<List<PersonelSayi>> response) {
                ...
                if (response.isSuccessful()) {
                    progressDoalog.dismiss();
                    gelenPersonelList = response.body();
                    if (gelenPersonelList != null && gelenPersonelList.size() > 0) {
                        get_listview();
    ...
    void get_listview() {
        personelSayiAdapter = new PersonelSayiAdapter(PersonelSorguActivity.this, R.layout.item_sekiz, gelenPersonelList);
    ...
    void filtre_spinner(final List<String> gelenBolgeListString, final List<SOrgBirim> gelenBolgeList, final List<SOrgBirim> gelenMudList, final List<SOrgBirim> gelenSeflikList) {
        ArrayAdapter<String> dataAdapter_bolge = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, gelenBolgeListString);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    ...
                    if (valInfo != null) {
                        ...
                        ArrayAdapter<String> dataAdapter_mudurluk = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, item_source_str_mudurluk);
                        ...
                        ArrayAdapter<String> dataAdapter_seflik = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, item_source_str_seflik);
    ...
    void filtre_spinner_il_ilce_koy() {
        ArrayAdapter<String> dataAdapter_bolge = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, OrtakFunction.il_list_string);
        dataAdapter_bolge.setDropDownViewResource(R.layout.mr_simple_spinner_dropdown_item);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    ...
                    if (valInfo != null) {
                        ...
                        ArrayAdapter<String> dataAdapter_ilce = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, item_source_str_ilce);
                        ...
                        ArrayAdapter<String> dataAdapter_koy = new ArrayAdapter<String>(PersonelSorguActivity.this, android.R.layout.simple_spinner_item, item_source_str_koy);
