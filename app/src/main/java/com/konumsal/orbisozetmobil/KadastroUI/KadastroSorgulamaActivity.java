package com.konumsal.orbisozetmobil.KadastroUI;
...
import AdapterLayer.Kadastro.KdmDosyaAdapter;
...
public class KadastroSorgulamaActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    KdmDosyaAdapter kadastroAdapter;
    List<KdmDosya> gelenKdmDosyaList;
    ListView listview;
    LinearLayout yilSorguLinear, baslikLinear1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kadastro_sorgulama_activity);
    ...
    private void initToolBar() {
        try {
            ...
            getSupportActionBar().setTitle("Orman Kadastrosu Listesi");
            ...
            toolbar.setNavigationOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    KadastroSorgulamaActivity.this.finish();
                }
            });

        } catch (Exception e) {
            e.printStackTrace();
            MessageBox.showAlert(KadastroSorgulamaActivity.this, "Hata:" + e.toString(), false);
    ...
    void Init() {
        ...
        yilSorguLinear = (LinearLayout) findViewById(R.id.yil_sorgu_linearlayout);
        yilSorguLinear.setVisibility(View.GONE);
        baslikLinear1 = (LinearLayout) findViewById(R.id.birinci_baslik);

        pd2 = new ProgressDialog(KadastroSorgulamaActivity.this);
    ...
    void getBalOrmaniServis() {
        ...
        parameters.prmBasMuhId = "-1";
        parameters.prmYil = "-1";

        final ProgressDialog progressDoalog;
        progressDoalog = new ProgressDialog(KadastroSorgulamaActivity.this);
        progressDoalog.setMessage("Lütfen bekleyiniz..");
        progressDoalog.setTitle("ORBİS");
        progressDoalog.setProgressStyle(ProgressDialog.BUTTON_NEGATIVE);
        progressDoalog.show();

        Call<List<KdmDosya>> call = refrofitRestApi.getKdmDepoDosyaListForMobil(parameters);
        call.enqueue(new Callback<List<KdmDosya>>() {
            @Override
            public void onResponse(Call<List<KdmDosya>> call, Response<List<KdmDosya>> response) {
                if (!response.isSuccessful()) {
                    progressDoalog.dismiss();
                    MessageBox.showAlert(KadastroSorgulamaActivity.this, "Servisle bağlantı sırasında hata oluştu...", false);
                    return;
                }
                if (response.isSuccessful()) {
                    progressDoalog.dismiss();
                    gelenKdmDosyaList = response.body();
                    if (gelenKdmDosyaList != null && gelenKdmDosyaList.size() > 0) {
                        get_listview();

                    } else
                        MessageBox.showAlert(KadastroSorgulamaActivity.this, "Kayıt bulunamamıştır..", false);
                }
            }

            @Override
            public void onFailure(Call<List<KdmDosya>> call, Throwable t) {
                progressDoalog.dismiss();
                MessageBox.showAlert(KadastroSorgulamaActivity.this, "Hata Oluştu.. " + t.getMessage(), false);
            }
        });
    ...
    void filtre_spinner() {
        ArrayAdapter<String> dataAdapter_bolge = new ArrayAdapter<String>(KadastroSorgulamaActivity.this, android.R.layout.simple_spinner_item, OrtakFunction.bolge_list_string);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    ...
                    if (valInfo != null) {
                        ...
                        ArrayAdapter<String> dataAdapter_mudurluk = new ArrayAdapter<String>(KadastroSorgulamaActivity.this, android.R.layout.simple_spinner_item, item_source_str_mudurluk);
                        ...
                        ArrayAdapter<String> dataAdapter_seflik = new ArrayAdapter<String>(KadastroSorgulamaActivity.this, android.R.layout.simple_spinner_item, item_source_str_seflik);
    ...
    void get_listview() {
        kadastroAdapter = new KdmDosyaAdapter(KadastroSorgulamaActivity.this, R.layout.item_yedi, gelenKdmDosyaList);
        listview.setAdapter(kadastroAdapter);
        kadastroAdapter.notifyDataSetChanged();
