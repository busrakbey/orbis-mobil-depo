...
public class OzmSorgulamaActivity  extends AppCompatActivity implements ExpandableLayout.OnExpansionUpdateListener{
    ...
    void filtre_spinner(final List<String> gelenBolgeListString, final List<SOrgBirim> gelenBolgeList, final List<SOrgBirim> gelenMudList, final List<SOrgBirim> gelenSeflikList) {
        ArrayAdapter<String> dataAdapter_bolge = new ArrayAdapter<String>(OzmSorgulamaActivity.this, android.R.layout.simple_spinner_item, gelenBolgeListString);
    ...
    void filtre_spinner_il_ilce_koy() {
        ArrayAdapter<String> dataAdapter_bolge = new ArrayAdapter<String>(OzmSorgulamaActivity.this, android.R.layout.simple_spinner_item, OrtakFunction.il_list_string);
        dataAdapter_bolge.setDropDownViewResource(R.layout.mr_simple_spinner_dropdown_item);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position > 0) {
                    ...
                    if (valInfo != null) {
                        ...
                        ArrayAdapter<String> dataAdapter_ilce = new ArrayAdapter<String>(OzmSorgulamaActivity.this, android.R.layout.simple_spinner_item, item_source_str_ilce);
                        ...
                        ArrayAdapter<String> dataAdapter_koy = new ArrayAdapter<String>(OzmSorgulamaActivity.this, android.R.layout.simple_spinner_item, item_source_str_koy);
