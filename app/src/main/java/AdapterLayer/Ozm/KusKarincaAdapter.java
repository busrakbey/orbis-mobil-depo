...
public class KusKarincaAdapter extends ArrayAdapter<KusKarinca> {

    Context context;

    public List<KusKarinca> faaliyet_detay_tablo_list;
    int layoutResID;
    int NameID;
    ...
    public KusKarincaAdapter(Context context, int layoutResourceID, List<KusKarinca> listItems)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final KusKarinca dItem = (KusKarinca) this.faaliyet_detay_tablo_list.get(position);
        final KusKarincaAdapter.DetayBilgiOzetItemHolder drawerHolder;
        view = convertView;
        ...
        if (view == null)
        {
            ...
            drawerHolder = new KusKarincaAdapter.DetayBilgiOzetItemHolder();
        ...
        {
            drawerHolder = (KusKarincaAdapter.DetayBilgiOzetItemHolder) view.getTag();
        }
        ...
        if(dItem.getKusYuvasiAdet() != null)
            drawerHolder.altinci_item.setText(dItem.getKusYuvasiAdet().toString());
        else
            drawerHolder.altinci_item.setText("");


        if(dItem.getKarincaNakliAdet() != null)
            drawerHolder.yedinci_item.setText(dItem.getKarincaNakliAdet().toString());
        else
