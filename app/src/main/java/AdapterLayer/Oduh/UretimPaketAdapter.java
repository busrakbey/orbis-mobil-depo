...
public class UretimPaketAdapter extends ArrayAdapter<UretimPaket> {

    Context context;

    public List<UretimPaket> faaliyet_detay_tablo_list;
    int layoutResID;
    int NameID;
    ...
    public UretimPaketAdapter(Context context, int layoutResourceID, List<UretimPaket> listItems)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final UretimPaket dItem = (UretimPaket) this.faaliyet_detay_tablo_list.get(position);
        final UretimPaketAdapter.DetayBilgiOzetItemHolder drawerHolder;
        view = convertView;
        ...
        if (view == null)
        {
            ...
            drawerHolder = new UretimPaketAdapter.DetayBilgiOzetItemHolder();
        ...
        {
            drawerHolder = (UretimPaketAdapter.DetayBilgiOzetItemHolder) view.getTag();
        }
