 ...
 */
public class MesireYeriAdapter  extends ArrayAdapter<MesireYeri> {

    Context context;

    public List<MesireYeri> faaliyet_detay_tablo_list;
    int layoutResID;
    int NameID;
    ...
    public MesireYeriAdapter(Context context, int layoutResourceID, List<MesireYeri> listItems)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MesireYeri dItem = (MesireYeri) this.faaliyet_detay_tablo_list.get(position);
