...
public class KdmDosyaAdapter extends ArrayAdapter<KdmDosya> {

    Context context;

    public List<KdmDosya> faaliyet_detay_tablo_list;
    int layoutResID;
    int NameID;
    ...
    public KdmDosyaAdapter(Context context, int layoutResourceID, List<KdmDosya> listItems)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final KdmDosya dItem = (KdmDosya) this.faaliyet_detay_tablo_list.get(position);
        final KdmDosyaAdapter.DetayBilgiOzetItemHolder drawerHolder;
        view = convertView;
        ...
        if (view == null)
        {
            ...
            drawerHolder = new KdmDosyaAdapter.DetayBilgiOzetItemHolder();
        ...
        {
            drawerHolder = (KdmDosyaAdapter.DetayBilgiOzetItemHolder) view.getTag();
        }
        ...
        if(dItem.getBasMuhAdi() != null)
            drawerHolder.ucuncu_item.setText(dItem.getBasMuhAdi());
        else
        ...
        if(dItem.getOrmanAlan() != null)
            drawerHolder.besinci_item.setText(dItem.getOrmanAlan().toString());
        else
